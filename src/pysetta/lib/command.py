...
from pysetta.lib.constants import COMBINED, TRANSLATABLE, TRANSLATION_SUFFIX
...
class Command:
    ...
    def extract_translatable(self) -> Extracted:
        ...
        for template in self.templates:
            ...
            for regex_match in TRANSLATABLE.finditer(template.read_text()):
                translation = Translation.from_text(regex_match.group("inner_text"))
    ...
    def get_translated_text(
        ...
        try:
            ...
            content = COMBINED.sub(translations, template_text)
